...
public class RoommateMatchingService : IRoommateMatchingService
{
    ...
    public async Task<List<RoommateMatchScoreDto>> GetMatchesForUserAsync(int userId, int topN = 10)
    {
        ...
        // Get all other active roommates
        ...
        // Get top N matches and populate roommate details
        var topMatches = matchScores
            .OrderByDescending(m => m.MatchPercentage)
            .Take(topN)
            .ToList();

        // Populate roommate DTOs
    ...
    /// <summary>
    /// Calculate budget compatibility based on budget range overlap
    /// </summary>
    private float CalculateBudgetCompatibility(Lander.src.Modules.Roommates.Models.Roommate user, Lander.src.Modules.Roommates.Models.Roommate candidate)
    {
        ...
        // Has overlap - calculate percentage of overlap
    ...
    /// <summary>
    /// Calculate lifestyle compatibility based on lifestyle, cleanliness, and profession
    /// </summary>
    private float CalculateLifestyleCompatibility(Lander.src.Modules.Roommates.Models.Roommate user, Lander.src.Modules.Roommates.Models.Roommate candidate)
    {
        ...
        // Profession similarity (optional, less weight)
    ...
    /// <summary>
    /// Calculate preferences compatibility (smoking, pets, guests)
    /// </summary>
    ...
    /// <summary>
    /// Calculate location compatibility based on preferred location
    /// </summary>
    ...
    /// <summary>
    /// Calculate string similarity using simple case-insensitive comparison
