...
public class E2eWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public Mock<IReviewFavoriteService> MockReviews  { get; } = new();
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.AddScoped<IReviewFavoriteService>(_ => MockReviews.Object);
    ...
    {
        MockReviews.Setup(g => g.CreateFavoriteAsync(It.IsAny<CreateFavoriteRequest>()))
                .ReturnsAsync(new FavoriteResponse());
        MockReviews.Setup(g => g.CreateReviewAsync(It.IsAny<CreateReviewRequest>()))
                .ReturnsAsync(new ReviewResponse());
        MockReviews.Setup(g => g.GetReviewByIdAsync(It.IsAny<int>()))
                .ReturnsAsync(new ReviewResponse());
        MockReviews.Setup(g => g.GetReviewsByApartmentIdAsync(It.IsAny<int>()))
                .ReturnsAsync(new GetReviewsResponse());
        MockReviews.Setup(g => g.DeleteReviewAsync(It.IsAny<int>(), It.IsAny<string>()))
                .ReturnsAsync(new DeleteResponse());
        MockReviews.Setup(g => g.DeleteFavoriteAsync(It.IsAny<int>(), It.IsAny<string>()))
                .ReturnsAsync(new DeleteResponse());
        MockReviews.Setup(g => g.GetUserFavoritesAsync(It.IsAny<int>()))
